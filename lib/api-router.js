...
module.exports = function(app, ops) {  
    ...
    function processMethod(ops){ 
        ...
        ops.parent.expressRoute[ops.verb](ops.anonymous === true && utils.passThrough || ops.authResolver, ops.anonymous === true && utils.passThrough || ops.authorizationResolver, ops.fun);
